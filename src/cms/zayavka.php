...
<td><table border="0" align=left cellpadding=0 cellspacing=0><tr>
	<td><a href="zayavka.html?r=<?echo $_GET[r],'&id_p';?>"><img border="0" src="images/arrow_blue_up.png" width="10" height="10"></td></tr><tr>
	<td><a href="zayavka.html?r=<?echo $_GET[r],'&id_p&method';?>"><img border="0" src="images/arrow_blue_down.png" width="10" height="10"></td></tr>
</table></td></tr></table>
				</td>
                <td bgcolor="#023761" align="center">
<table><tr><td><b><font size="1" face="arial" color=#ffffff>Користувачі</font></b>
<td><table border="0" align=left cellpadding=0 cellspacing=0><tr>
	<td><a href="zayavka.html?r=<?echo $_GET[r],'&login';?>"><img border="0" src="images/arrow_blue_up.png" width="10" height="10"></td></tr><tr>
	<td><a href="zayavka.html?r=<?echo $_GET[r],'&login&method';?>"><img border="0" src="images/arrow_blue_down.png" width="10" height="10"></td></tr>
</table></td></tr></table>
                </td>
...
<td bgcolor="#023761" align="center" ><b><font size="1" face="arial" color=#ffffff>ICQ</font></b></td>
	...
	echo '
        ...
        for($i=0;$i<count($rozdil_p)-1;$i++){        	$id=$rozdil_p[$i];
