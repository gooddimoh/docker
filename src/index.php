...
$k1=mysql_query("select * from katalog_config limit 1");
var_dump($k1);
...
<?php if(0 && $_SERVER["REMOTE_ADDR"] == '46.118.243.173'): ?>
    <?php echo CustomSessions::id() . '<br />';
