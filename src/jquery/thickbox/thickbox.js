...
*/
      if (imageWidth > 400) {
        imageHeight = imageHeight * (400 / imageWidth); 
        imageWidth = 400; 
      }
      ...
      $("#TB_window").append("<div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='X'>X</a></div><a href='' id='TB_ImageOff' title='X'><img id='TB_Image' src='"+url+"' width='"+imageWidth+"' height='"+imageHeight+"' alt='"+caption+"'/></a>" + "<div id='TB_caption'>"+caption+"<div id='TB_secondLine'>" + TB_imageCount + TB_PrevHTML + TB_NextHTML + "</div></div>");     
