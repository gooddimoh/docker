...
<link rel="stylesheet" type="text/css" href="/jquery/plugins/datePicker/datePicker.css">
...
<script type="text/javascript" src="jquery/jquery.placeholderpatch.js"></script>
...
function reload_page(get)
{
    window.location = '?' + get;
}
    
    function ac(a){ return a[0];
	}
$(document).ready(function(){
	jQuery("#poisk").autocomplete('/ajaxs.php', {selectFirst:false, multiple: false,minChars:3,delay:200,matchContains: true,formatItem: ac,formatResult: ac,width :290});
	
	
	$('#poisk').placeholder();
	//$('.searchPage').parents('body').addClass('hiderow');
	//$('.methodsPage').parents('body').addClass('hiderow');
	//$('.myShopTable').parents('body').addClass('hiderow');
	//$('.methodsPage').parents('.center').css('padding-right','0');
	$('.searchResults a img[src*=".jpg"]').parent().addClass('imgWrap');
				...
				<tr>
					<td style="height:80px;">
						<table style="width:100%;height:80px" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td style="background:url('images/topfon.gif') repeat-x 0% 0%; height:80px;" >
                                <img alt="Решение задач" title="Решение задач" src="images/topfon.gif" style="z-index: -10; position: absolute;" />
			...
			<table style="height:100%" border="0" cellpadding=0 cellspacing=0>
				<tr>
					<?
						...
						echo '
					<td><a href="k21.html" class="topmenu profile">Мой профиль</a></td>
					...
					echo ' <a href="k18.html?in" class="topmenu messeges">Сообщения</a></td>
					<td><img alt="" border="0" src="images/line.gif" width="11" height="45"></td>
					<td><a href="k19.html" class="topmenu balance">Баланс</a></td>
					<td><img alt="" border="0" src="images/line.gif" width="11" height="45"></td>
					<td><a href="k135.html" class="topmenu myShop">Мой магазин</a></td>
					<td><img alt=""  border="0" src="images/line.gif" width="11" height="45"></td>
					<td><a href="k134.html" class="topmenu files">Файлы</a></td>
					<td><img alt=""  border="0" src="images/line.gif" width="11" height="45"></td>
					<td><a href="k2.html" class="topmenu users">Пользователи</a></td>
					<td><img alt=""  border="0" src="images/line.gif" width="11" height="45"></td>
					<td><a href="k6.html" class="topmenu tasks">Задачи</a></td>
					<td><img alt=""  border="0" src="images/line.gif" width="11" height="45"></td>
					<td><a href="k13.html" class="topmenu contacts">Контакты</a></td>';
					}else{
					echo '
					<td><a href="k16.html" class="topmenu reg">Регистрация</a></td>
					<td><img alt=""  border="0" src="images/line.gif" width="11" height="45"></td>
					<td><a href="k2.html" class="topmenu users">Пользователи</a></td>
					<td><img alt=""  border="0" src="images/line.gif" width="11" height="45"></td>
					<td><a href="k6.html" class="topmenu tasks">Задачи</a></td>
...
<tr>
	<td style="background:url('images/topfon_menu_a.gif') repeat-x 0% 0%; height:26px;" >
		<table style="height:100%; width:100%;" border="0" cellpadding=0 cellspacing=0>
			<tr>
				...
				<?
					...
					echo '
						<td><font color="#FFFFFF" face="Arial" style="font-size: 9pt">Вы вошли как <img alt=""  src="images/user.png"> <a href="k77.html?id_user=',$_SESSION[userid],'">',ucfirst($_SESSION[userlogin]),'</a>
						...
						echo '
						<td><font color="#FFFFFF" face="Arial" style="font-size: 9pt">Вы вошли как Гость <img alt=""  src="images/user.png"> </font>
...
<tr>
	<td style="background: #223A47;">
		<div class="horNav">
			<ul>
				<li><a href="k6.html" title="Текущие задачи" class="infobold menu1">Текущие задачи</a></li>
				<li><a href="/k136.html" title="Магазин готовых задач" class="infobold menu2">Магазин готовых задач</a></li>
				<li><a href="/k7-oformit_zakaz_pravila_zakaza_zadachi.html" title="Заказать задачу" class="infobold menu3">Заказать задачу</a></li>
				<li><a href="/k14-oplata_resheniya_zadach_sotrudnichestvo_reshenie_zadach_na_zakaz.html" title="Решить задачу" class="infobold menu4">Стать Решающим задачи</a></li>
				<li><a href="/k135.html" title="Решить задачу" class="infobold menu5">Загрузить задачу в магазин</a></li>
			</ul>
		</div>
		
	<!--	<table class="horNav" align=left border="0" cellpadding=0 cellspacing=0>
			<tr>
				<td width="20%">
					<a href="k6.html" title="Текущие задачи" class="infobold">Текущие задачи</a>
				</td>
				<td width="20%">
					<a href="/k136.html" title="Магазин готовых задач" class="infobold" style="text-indent: 35px;">Магазин готовых задач</a>
				</td>
				<td width="20%">
					<a href="/k7-oformit_zakaz_pravila_zakaza_zadachi.html" title="Заказать задачу" class="infobold">Заказать задачу</a>
				</td>
				<td width="20%">
					<a href="/k6.html" title="Решить задачу" class="infobold">Стать Решающим задачи</a>
				</td>
				<td width="20%">
					<a href="/k6.html" title="Решить задачу" class="infobold">Стать Решающим задачи</a>
				</td>
		...
		<div class="horNav">
			<a href="k6.html" title="Текущие задачи" class="infobold first">Текущие задачи</a>
			<a href="/k136.html" title="Магазин готовых задач" class="infobold second" style="text-indent: 35px;">Магазин готовых задач</a>
			<a href="/k7-oformit_zakaz_pravila_zakaza_zadachi.html" title="Заказать задачу" class="infobold third">Заказать задачу</a>
			<a href="/k6.html" title="Решить задачу" class="infobold last">Решить задачу</a>
		</div>
	-->
	</td>
</tr>
				<tr>
					<td>
						<table border="0" cellpadding=0 cellspacing=0 style="background:url('images/content.gif') repeat-x 100% 0%; width:100%; height:100%;">
							<tr>
								...
								<table border="0" width="100%">
									...
									<?include "news.php";?>
				<p id="calendar-me"></p>
			<script type='text/javascript' src='/jquery/plugins/datePicker/jquery.datePicker.js'></script>
				<script type="text/javascript" src="/jquery/plugins/datePicker/eye.js"></script>
				<script type="text/javascript" src="/jquery/plugins/datePicker/utils.js"></script>
				<script type="text/javascript" src="/jquery/plugins/datePicker/layout.js?ver=1.0.2"></script>

			<script type="text/javascript">jQuery('#calendar-me').DatePicker({flat: true,date: '<?=Date("Y-m-d")?>', current: '<?=Date("Y-m-d")?>'});</script>
			...
			<img alt="www.megastock.ru" width="88" vspace="6" height="31" src="http://www.webmoney.ru/img/icons/88x31_wm_blue_on_transparent_ru.png">
			</a>
			<!-- end WebMoney Transfer : accept label -->
			<!-- begin WebMoney Transfer : attestation label -->
			<a href="https://passport.webmoney.ru/asp/certview.asp?wmid=264265686165" target="_blank"><img style="padding-bottom:6px" src="grey_light_rus.png" alt="Здесь находится аттестат нашего WM идентификатора 264265686165" border="0"><!--img src="grey_light_rus.gif" alt="Здесь находится аттестат нашего WM идентификатора 264265686165" border="0"--><br><span style="font-size: 0,7em;">Проверить аттестат</span></a>
			...
			<!-- www.top150.ru -->
			<SCRIPT type="text/javascript" SRC="http://www.top150.ru/top.php?id=1790&amp;js=1"></SCRIPT>
			<NOSCRIPT><a href="http://www.top150.ru/" style="cursor:hand;"><img src="http://www.top150.ru/top.php?id=1790&amp;js=0" border="0" alt=""/></a></NOSCRIPT>
			...
			<script type="text/javascript" src="http://counter.rambler.ru/top100.jcn?2893725"></script>
			<noscript>
	...
	<td class="center" valign=top>
		...
		<? if($ide=='' or $d=='4') echo '
			<div class="choose">
				<a href="/k136.html"><img alt="" src="images/shop.png" /></a>
				<a href="/k7-oformit_zakaz_pravila_zakaza_zadachi.html"><img alt="" src="images/zakaz.png" /></a>
				<a href="/k14-oplata_resheniya_zadach_sotrudnichestvo_reshenie_zadach_na_zakaz.html"><img alt="" src="images/reshit.png" /></a>
				<div class="line"></div>
				<p><a href="/k136.html">Кликните, чтобы найти готовые или же продать свои решенные задачи, курсовые и дипломы</a></p>
				<p><a href="/k7-oformit_zakaz_pravila_zakaza_zadachi.html">Кликните, чтобы заказать решить новую задачу</a></p>
				<p><a href="/k14-oplata_resheniya_zadach_sotrudnichestvo_reshenie_zadach_na_zakaz.html">Для получения статуса "Решающего" задачи - в своем профиле подайте заявку на сотрудничество</a></p>
			</div>';
		?>
        <?if($_SERVER['REQUEST_URI'] != '/'):?>
        
            <?if($name != ''):?>
                <a href="/">Главная</a> - <span><?=$name?></span>
                <h1><?=$name?></h1>
            <?endif?>
        ...
        var full_text, bottom_text_el;
        
        $(document).ready(function(){
            return;
            bottom_text_el = $('#seo-bottom-text');
            full_text = bottom_text_el.html();
            bottom_text_el.html(full_text.substr(0, 30) + '...');
          
            $('<a href="#">Подробнее<\/a>').appendTo(bottom_text_el).click(function(){
                bottom_text_el.html(full_text);
               // $(this).remove();
                return false;
            });
        });
         ...
         <div id="seo-bottom-text" style="margin-top: 20px; text-align: left; margin-bottom: 15px;">
          <?=BOTTOM_SEO_TEXT?>
         </div>
        ...
        <?endif?>
				...
				<? //if($ide!='' && $d!='4' &&$d!=135&&$d!=136&&$d!=137) {?>
				<? if($ide!='' && $d!='4' &&$d!=137) {
					echo '<td class="rightCol test1" valign=top>
						<table border="0" cellpadding=0 cellspacing=0>';
						include "modul/metods_block.php";
					echo '</td><!-- end of .test1 -->';
				} ?>
								

				<? if($ide=='' or $d=='4') echo '<td class="rightCol mainPage test2" valign=top>
				<table border="0" cellpadding=0 cellspacing=0>';
					if($ide=='') { ?>
					<tr>
						<? include "modul/metods_block.php"; ?>
					...
					echo '<tr class="row">
						<td  style="background:url(\'images/menu1.gif\') no-repeat 0% 0%;height:134px;/*padding:14px*/" valign=bottom align=center>
						<b><span lang="ru">
	...
	<td height=55>
		<table border="0" cellpadding=0 cellspacing=0 width="100%" style="background:url('images/bottom_right.gif') repeat-x 100% 0%">
			<tr>
				...
				<td></td>
				<td style="background:url('images/bottom_one.gif') no-repeat 0% 0%;padding:10px; width:420px; height:55px;" >
			...
			<script type="text/javascript" src="http://jspy.ru/load/855/jspy.js"></script>
			<script type="text/javascript" src='http://scan.botscanner.com/'></script> <noscript><img alt=""  src='http://scan.botscanner.com/noscript' /></noscript>
