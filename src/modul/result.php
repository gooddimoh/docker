...
<table border="0" width=500 align=center style="border: 1px solid #529F33" cellspacing="10" bgcolor="#F8FCF5" cellpadding="0" id="result">
        <tr>
			...
			echo'</font><img alt=""  src="images/close.png" border=0 align="right" style="cursor:hand;cursor:pointer" onclick="jQuery.post(\'index.php?clean&id=1&st=6\');document.getElementById(\'result\').style.display=\'none\';">
			</td>
        </tr>
</table>';
